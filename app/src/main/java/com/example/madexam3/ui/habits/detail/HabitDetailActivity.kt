package com.example.madexam3.ui.habits.detail
...
import com.example.madexam3.data.model.HabitCompletion
import com.example.madexam3.databinding.ActivityHabitDetailBinding
...
class HabitDetailActivity : AppCompatActivity() {
    ...
    private fun setupClickListeners() {
        binding.btnEditHabit.setOnClickListener {
            val intent = Intent(this, com.example.madexam3.ui.habits.edit.EditHabitActivity::class.java)
    ...
    private fun loadHabitData() {
        binding.apply {
            ...
            val trackingInfo = when (habit.trackingType) {
                com.example.madexam3.data.model.TrackingType.CHECKBOX -> "Simple completion tracking"
                com.example.madexam3.data.model.TrackingType.COUNTER -> "Target: ${habit.targetValue} ${habit.unit}"
                com.example.madexam3.data.model.TrackingType.TIMER -> "Target: ${habit.targetValue} minutes"
            }
        ...
        for (completion in sortedCompletions) {
            try {
                ...
                val valueText = when (habit.trackingType) {
                    com.example.madexam3.data.model.TrackingType.CHECKBOX -> "Completed"
                    com.example.madexam3.data.model.TrackingType.COUNTER -> "${completion.value} ${habit.unit}"
                    com.example.madexam3.data.model.TrackingType.TIMER -> "${completion.value} minutes"
                }
