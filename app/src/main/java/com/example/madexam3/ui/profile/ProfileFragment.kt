package com.example.madexam3.ui.profile
...
import com.example.madexam3.databinding.FragmentProfileBinding
import java.util.*
...
class ProfileFragment : Fragment() {
    ...
    private fun loadProfileData() {
        ...
        binding.apply {
            tvProfileName.text = "Coffee Lover"
            tvProfileEmail.text = "justme@coffee.com"
