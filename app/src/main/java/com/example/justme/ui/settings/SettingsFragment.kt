package com.example.justme.ui.settings
...
import com.example.justme.databinding.FragmentSettingsBinding
import com.example.justme.notifications.HydrationNotificationWorker
...
class SettingsFragment : Fragment() {
    ...
    private fun showResetDataConfirmation() {
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setMessage(getString(com.example.justme.R.string.reset_confirmation))
