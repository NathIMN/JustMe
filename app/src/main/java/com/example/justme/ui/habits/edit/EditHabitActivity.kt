package com.example.justme.ui.habits.edit
...
import com.example.justme.databinding.ActivityEditHabitBinding
...
class EditHabitActivity : AppCompatActivity() {
            ...
            when (habit.trackingType) {
                ...
                com.example.justme.data.model.TrackingType.TIMER -> {
                    ...
                    tvUnit.text = habit.unit.ifEmpty {
                        if (habit.trackingType == com.example.justme.data.model.TrackingType.TIMER) "minutes" else "N/A"
                    }
                }
            }
        }
    ...
    private fun saveChanges() {
        ...
        val newTargetValue = when (habit.trackingType) {
            com.example.justme.data.model.TrackingType.CHECKBOX -> habit.targetValue // Keep existing value
            else -> {
